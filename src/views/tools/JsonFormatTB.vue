<template>
  <ToolLayout title="JSON 格式化(上下)">
    <div class="json-format-tb">
      <div class="tool-bar">
        <div class="bar-left">
      ...
      <div class="panels">
        <div class="panel">
          ...
          <textarea ref="inputRef" v-model="inputJson" class="code-area" placeholder="粘贴或输入 JSON 数据..." @input="autoValidate"></textarea>
        ...
        <div class="panel">
          ...
          <textarea ref="outputRef" v-model="outputJson" class="code-area" placeholder="格式化后的结果..." readonly></textarea>
          <div class="panel-footer">
...
<style scoped>
.json-format-tb { display: flex; flex-direction: column; gap: 12px; }
...
.code-area { width: 100%; min-height: 200px; padding: 12px; border: 1px solid #d0d7de; border-radius: 6px; font-family: 'Fira Code', 'Courier New', monospace; font-size: 13px; resize: vertical; line-height: 1.6; background: #f6f8fa; box-sizing: border-box; }
