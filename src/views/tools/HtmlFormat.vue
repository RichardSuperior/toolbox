    ...
    <div class="html-format">
      ...
      <div class="editor-wrap">
        <div class="input-wrap">
          <div class="label">输入 HTML</div>
          <textarea v-model="input" class="code-area" placeholder="<div><p>Hello World</p></div>"></textarea>
        </div>
...
<style scoped>
.html-format { display: flex; flex-direction: column; gap: 12px; }
