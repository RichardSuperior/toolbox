  ...
  <ToolLayout title="Java 代码格式化">
    <div class="fmt-tool">
      ...
      <div class="editor-wrap">
        <textarea v-model="input" class="code-area" placeholder="public class Main{public static void main(String[] args){System.out.println(&quot;Hello&quot;);}}"></textarea>
